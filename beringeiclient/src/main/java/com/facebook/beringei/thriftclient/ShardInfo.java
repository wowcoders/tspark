...
public class ShardInfo implements org.apache.thrift.TBase<ShardInfo, ShardInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ShardInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ShardInfo");
  ...
  private static final org.apache.thrift.protocol.TField HOST_ADDRESS_FIELD_DESC = new org.apache.thrift.protocol.TField("hostAddress", org.apache.thrift.protocol.TType.STRING, (short)2);
  private static final org.apache.thrift.protocol.TField PORT_FIELD_DESC = new org.apache.thrift.protocol.TField("port", org.apache.thrift.protocol.TType.I32, (short)3);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new ShardInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ShardInfoTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    HOST_ADDRESS((short)2, "hostAddress"),
    PORT((short)3, "port");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ShardInfo.class, metaDataMap);
  }
  ...
  public int hashCode() {
    ...
    boolean present_hostAddress = true && (isSetHostAddress());
    list.add(present_hostAddress);
    if (present_hostAddress)
  ...
  public int compareTo(ShardInfo other) {
    ...
    if (isSetHostAddress()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.hostAddress, other.hostAddress);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class ShardInfoStandardSchemeFactory implements SchemeFactory {
    public ShardInfoStandardScheme getScheme() {
      return new ShardInfoStandardScheme();
    }
  }

  private static class ShardInfoStandardScheme extends StandardScheme<ShardInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ShardInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ShardInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ShardInfoTupleSchemeFactory implements SchemeFactory {
    public ShardInfoTupleScheme getScheme() {
      return new ShardInfoTupleScheme();
    }
  }

  private static class ShardInfoTupleScheme extends TupleScheme<ShardInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ShardInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ShardInfo struct) throws org.apache.thrift.TException {
